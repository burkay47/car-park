...
im0 = cv2.imread("images//0_img.jpg",0)
im1 = cv2.imread("images//1_img.jpg",0)

print(compare(im0,im1))
threshold = 10  # Benzerlik eşik değeri
similarity_score = compare(im0, im1)

if similarity_score < threshold:
    print("Park alanı dolu.")
else:
    print("Park alanı boş")
